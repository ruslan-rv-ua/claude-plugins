...
| Плагін | Скіли | Опис |
|---|---|---|
| [plugin-creator](plugins/plugin-creator/) | `/plugin-creator:new-plugin` | Створює нові плагіни на основі чернеток з папки `drafts/` |
| [uvify](plugins/uvify/) | `/uvify:adapt` | Перетворює Python-скрипти на самодостатні uv-скрипти (PEP 723) |
...
│   │       └── new-plugin/
│   │           └── SKILL.md
│   └── uvify/                  # Перетворення Python-скриптів на uv-сумісні (PEP 723)
│       ├── .claude-plugin/
│       │   └── plugin.json
│       ├── skills/
│       │   └── adapt/
